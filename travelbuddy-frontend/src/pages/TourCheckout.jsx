...
const TourCheckout = () => {
  ...
  const { tour, totalAmount, travellers } = state;
  ...
  const handlePayment = async () => {
    ...
    console.log('💳 Tour payment started');
      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="bg-white rounded-t-2xl shadow-sm border border-gray-100 p-8">
          <div className="flex items-center gap-3 mb-2">
            ...
            <h1 className="text-2xl font-bold text-gray-900">Tour Checkout</h1>
          </div>
          <p className="text-gray-500">Complete your tour booking</p>
        </div>
          ...
          <div className="space-y-6 mb-8">
            ...
            <div className="grid grid-cols-2 gap-4 pb-6 border-b border-gray-100">
              ...
              <div>
                ...
                <p className="font-semibold text-gray-900">₹{tour.price?.toLocaleString()}</p>
              </div>
              <div>
